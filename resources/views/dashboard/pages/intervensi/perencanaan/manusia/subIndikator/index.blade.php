...
@section('buttonPanelHeader')
    @if (Auth::user()->role == 'OPD')
        <a href="{{ route('rencana-intervensi-manusia.create') }}" class="btn btn-secondary btn-round"><i
                class="fas fa-plus"></i>
            Tambah</a>
    @endif
@endsection
...
@section('contents')
    <div class="row">
        <div class="col-12 {{ $totalMenungguKonfirmasiPerencanaanManusia == 0 ? 'd-none' : '' }}">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-{{ Auth::user()->role == 'OPD' ? 'danger' : 'warning' }} d-flex justify-content-between mb-0"
                        role="alert">
                        <span>
                            Terdapat <b>{{ $totalMenungguKonfirmasiPerencanaanManusia }}</b> data perencanaan yang
                ...
                <div class="card-header">
                    <div class="card-head-row">
                        ...
                        <div class="card-tools">
                            <form action="{{ url('export-perencanaan-manusia') }}" method="POST">
                                @csrf
