...
@section('title')
    Detail Laporan Realisasi Intervensi Manusia
@endsection

@section('titlePanelHeader')
    Detail Laporan Realisasi Intervensi Manusia | <span style="text-decoration: underline">Laporan Tanggal:
        {{ Carbon\Carbon::parse($realisasi_intervensi_manusia->created_at)->translatedFormat('j F Y') }}</span>
@endsection
                            ...
                            <tbody>
                                @foreach ($dataPendudukRealisasi as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $item->desa->nama }}</td>
                                        <td class="text-center"><button type="button"
                                                class="btn btn-primary btn-rounded btn-sm mr-1" id="btn-lihat"
                                                value="{{ $item->id }}"><i class="far fa-eye"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
