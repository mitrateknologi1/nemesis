            ...
            @foreach ($dataRealisasi as $item)
                <tr style="vertical-align: center;border: 1px solid black;">
                    ...
                    <td style="vertical-align: center;border: 1px solid black;" align="left">
                        {{ $item->perencanaanKeong->sub_indikator }}</td>
                    <td style="vertical-align: center;border: 1px solid black;" align="center">
                        {{ $item->perencanaanKeong->opd->nama }}</td>
                    <td style="vertical-align: center;border: 1px solid black;" align="left">
                        @forelse ($item->perencanaanKeong->opdTerkaitKeong as $item2)
                    ...
                    <td style="vertical-align: center;border: 1px solid black;" align="right">
                        {{ $item->perencanaanKeong->nilai_pembiayaan }}</td>
                    <td style="vertical-align: center;border: 1px solid black;" align="center">
                        {{ $item->perencanaanKeong->sumberDana->nama }}</td>
                    <td style="vertical-align: center;border: 1px solid black;" align="center">
                        {{ $item->lokasiRealisasiKeong->count() }}</td>
                    <td style="vertical-align: center;border: 1px solid black;" align="left">
                        @forelse ($item->lokasiRealisasiKeong as $item2)
