...
@section('title')
    Ubah Perencanaan Intervensi Habitat Keong
@endsection
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Form Perencanaan Intervensi Habitat Keong</div>
                    </div>
                </div>
                <div class="card-body pt-1">
                    @if ($rencanaIntervensiKeong->status == 2)
                        <div class="row">
                            <div class="col">
                                <div class="alert alert-danger mt-3 font-weight-bold" role="alert">Alasan Ditolak: <span
                                        class="text-danger">{{ $rencanaIntervensiKeong->alasan_ditolak }}</span></div>
                            </div>
                        </div>
                    @endif
                    <div class="row">
