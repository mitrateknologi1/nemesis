...
@section('contents')
    <div class="row">
        <div class="col-12 {{ $totalMenungguKonfirmasiRealisasiManusia == 0 ? 'd-none' : '' }}">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-{{ Auth::user()->role == 'OPD' ? 'danger' : 'warning' }} d-flex justify-content-between mb-0"
                        role="alert">
                        <span>
                            Terdapat <b>{{ $totalMenungguKonfirmasiRealisasiManusia }}</b> data laporan realisasi yang
                ...
                <div class="card-header">
                    <div class="card-head-row">
                        ...
                        <div class="card-tools">
                            <form action="{{ url('export-realisasi-manusia') }}" method="POST">
                                @csrf
                        ...
                        <div class="col-md-6">
                            @component('dashboard.components.formElements.select',
                                ...
                                @slot('options')
                                    ...
                                    @foreach ($realisasiManusia->groupBy('opd_id')->get() as $item)
